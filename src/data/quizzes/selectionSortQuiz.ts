...
export const selectionSortQuiz: Question[] = [
  {
  ...
  {
    question: 'In selection sort, after the first full pass through the array, what is guaranteed?',
    options: [
  ...
  {
    question: 'How many comparisons are made in the first pass of selection sort on an array of n elements?',
    options: ['n', 'n - 1', 'n / 2', 'n²'],
    correctIndex: 1,
  },
  {
    question: 'Which of the following best describes what selection sort does on each pass?',
    options: [
